...
public class Messaging {
    ...
    private static final String PROJECT_ID = "push-2ec94";
    ...
    private static String getAccessToken() throws IOException {
        String firebaseConfigPath = "config/firebase/service-account.json";
    ...
    public static void message(String[] args) throws IOException {
        sendCommonMessage();
